...
def define_optimizer(model) -> optim.Adadelta:
    optimizer = optim.Adadelta(model.parameters(), config.model_lr, config.model_rho)
...
def train(model: nn.Module,
    ...
    Args:
        ...
        optimizer (optim.Adadelta): optimizer for optimizing generator models in networks
